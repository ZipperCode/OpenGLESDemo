        ...
        override fun process(input: ByteArray, offset: Int, len: Int, finish: Boolean): Boolean {
            ...
            when (tailLen) {
                ...
                1 -> {
                    if (p + 2 <= len) {
                        ...
                        v = ((tail[0].toInt() and 0xff) shl 16 or
                                ((input[p++].toInt() and 0xff) shl 8)) or (input[p++].toInt() and 0xff)
                        tailLen = 0
                    }
                }
                ...
                2 -> if (p + 1 <= len) {
                    ...
                    v = ((tail[0].toInt() and 0xff) shl 16) or
                            ((tail[1].toInt() and 0xff) shl 8) or (input[p++].toInt() and 0xff)
                    tailLen = 0
                }
            }
            if (v != -1) {
            ...
            while (p + 3 <= len) {
                v = ((input[p].toInt() and 0xff) shl 16 or
                        ((input[p + 1].toInt() and 0xff) shl 8)) or (input[p + 2].toInt() and 0xff)
                output[op] = alphabet[v shr 18 and 0x3f]
