...
import com.zipper.gl.base.GLConstant
...
abstract class BaseShader {
    private var vertexBuffer = ByteBuffer.allocateDirect(GLConstant.VERTEX.size * 4)
        .order(ByteOrder.nativeOrder())
        .asFloatBuffer()
        .put(GLConstant.VERTEX)
        .position(0)
    private var textureBuffer = ByteBuffer.allocateDirect(GLConstant.TEXTURE.size * 4)
        .order(ByteOrder.nativeOrder())
        .asFloatBuffer()
        .put(GLConstant.TEXTURE)
        .position(0)
